...
import ContactUsReqTables from "./pages/Tables/contactus";
import TakeTourTable from "./pages/Tables/tour";
import AdmissionEnqTables from "./pages/Tables/admissionEnq";
import { Navigate } from "react-router-dom";
import BannerTable from "./pages/Tables/banner";
import WelcomeTable from "./pages/Tables/welcome";
import EveryChildTable from "./pages/Tables/EveryChild";
import CbseTable from "./pages/Tables/cbseT";
import SchoolActivityTable from "./pages/Tables/schoolActivity";
import SteamTable from "./pages/Tables/steam";
import StudentExperienceTable from "./pages/Tables/studentExperience";
...
import GalleryTables from "./pages/Tables/gallery";
