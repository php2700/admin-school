...
import ApplicationFormBannerEditor from "../../components/tables/applicationformBanner";

export default function ApplicationnFormBanner() {
  return (
    <>
      <PageMeta
      ...
      />
      <PageBreadcrumb pageTitle="Application Form Banner " />
      <div className="space-y-6">
        <ComponentCard title="Application Form Banner ">
          <ApplicationFormBannerEditor />
        </ComponentCard>
      </div>
    </>
  );
