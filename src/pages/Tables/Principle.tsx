...
import PrincipleEditor from "../../components/tables/PrincipleTab";

export default function Priciple() {
  return (
    <>
      <PageMeta
      ...
      />
      <PageBreadcrumb pageTitle="Priciple " />
      <div className="space-y-6">
        <ComponentCard title="Priciple ">
          <PrincipleEditor />
        </ComponentCard>
      </div>
    </>
